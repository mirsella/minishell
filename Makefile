...
SRCS_PARSING = parse.c skipping.c pipeline_type.c check_unclosed_and_invalid_pipeline.c parse_redirections.c handle_redirections.c parse_line_to_proc.c set_full_path.c \
